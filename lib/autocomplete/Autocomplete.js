  ...
  var Autocomplete = function (_Component) {
    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _this.setState({ query: value, showAllSuggestions: false, active: null }, function () {
          if (_this.props.inputOnChange) _this.props.inputOnChange(value);
        });
    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            inputOnChange = _props.inputOnChange,
            theme = _props.theme,
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'label', 'source', 'suggestionMatch', 'selectedPosition', 'keepFocusOnChange', 'showSuggestionsWhenValueIsSet', 'showSelectedWhenNotInSource', 'onQueryChange', 'inputOnChange', 'theme']);
